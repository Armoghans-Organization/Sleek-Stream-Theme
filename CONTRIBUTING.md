...
- **Ensure the bug has not already been reported** by searching [GitHub Issues](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/issues). If there's already an open issue, feel free to add any extra information you might have about the issue.
- If you're unable to find an open issue matching the problem, [open a new one](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample**, **screenshot**, or a **test case** demonstrating the expected behavior that is not occurring.
...
- Enhancements are welcome but before implementing any features, be sure to suggest your change by opening a [new discussion](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/discussions/new) about your idea. Enhancements are discussed to ensure they fit with the project's design intent and overall roadmap.
- Before opening a discussion, [check to see](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/discussions/categories/ideas) if a similar idea is already being discussed.
...
- If you have a general question, these should be asked using [GitHub Discussions](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/discussions). Feel free to open a [new discussion](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/discussions/new) to ask your question using the "Q&A" category.
- Be sure to check if your question has already been answered by searching [existing Q&A discussions](https://github.com/Armoghans-Organization/Sleek-Stream-Theme/discussions/categories/q-a).
